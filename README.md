<div align="center">
  ...
  2. 내시경 이미지데이터 역시 사이즈 초과 문제와 의학 데이터인 점을 고려하여 공유할 수 없음을 알려드립니다.
  3. 해당 프로젝트에서 담당했던 역할은 **데이터 전처리(이미지 자르기, 파일명 변경, 라벨링)** 와 **Yolov5 모델**을 맡아 구현했으며, 그 외 웹서비스, XGBoost 모델 등은 타 팀원들이 구현하였습니다.
