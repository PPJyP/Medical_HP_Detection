...
<div align="center">
  ...
  * 인공지능 의사 왓슨은 미국내에서는 정확도가 높지만 다른 나라에 도입시 **동서양인의 신체 및 문화 차이로 인해 정확도가 떨어지는** 것으로 판단되었으며, 이러한 문제를 해결하고자 해당 프로젝트를 시작하게 되었습다.
...
<div align="center">
  ...
  * 위 사진에서 "metrics/precision" 그래프를 보면 **이미지가 적으면 더이상 precision이 증가하지 않는** 것을 확인할 수 있습니다.
